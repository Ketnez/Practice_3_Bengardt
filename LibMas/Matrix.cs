...
namespace LibMas
{
    ...
    {
        public static void Fill(int[,] matrix, int fillValue)
        {
        ...
        public static void RandomValues(int[,] matrix, int minValue, int maxValue)
        {
        ...
        public static void Open(string path, out int[,] matrix)
        {
